...
class LogisticRegressionBuilder:
    ...
    def set_penalty(self):
        ...
        while True:
            user_input = input(
                "Select penalty type (1-4, or 'none' for default): "
            ).strip()
    ...
    def set_regularization_strength(self):
        ...
        while True:
            user_input = input(
                "Enter the regularization strength (positive float, or 'none' for default): "
            ).strip()
            if user_input.lower() in ["none", "n"]:
    ...
    def set_random_state(self):
        ...
        while True:
            user_input = input(
                "Enter the random state (positive integer, or 'none' for default): "
            ).strip()
            if user_input.lower() in ["none", "n"]:
    ...
    def set_LR_model(self):
        ...
        self.__LR_config["model"] = LogisticRegression(
            penalty=self.__LR_config["penalty"],
