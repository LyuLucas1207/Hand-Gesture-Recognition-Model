...
class KNearestNeighborsBuilder:
    ...
    def set_n_neighbors(self):
        ...
        while True:
            user_input = input("Enter the number of neighbors (positive integer, or 'none' for default): ").strip()
    ...
    def set_weights(self):
        ...
        while True:
            user_input = input("Select weights (1 for 'uniform', 2 for 'distance', or 'none' for default): ").strip()
            if user_input.lower() in ['none', 'n']:
    ...
    def set_algorithm(self):
        ...
        pt.print_boxed_options(options=KNN_algorithm, additional_option="None/N. Default")
        while True:
            user_input = input("Select algorithm (1-4, or 'none' for default): ").strip()
            if user_input.lower() in ['none', 'n']:
    ...
    def set_leaf_size(self):
        ...
        while True:
            user_input = input("Enter the leaf size (positive integer, or 'none' for default): ").strip()
            if user_input.lower() in ['none', 'n']:
    ...
    def set_KNN_model(self):
        ...
        self.__KNN_config['model'] = KNeighborsClassifier(n_neighbors=self.__KNN_config['n_neighbors'],
...
def create_KNN_trainer():
    ...
    while loop:
        ...
        KNN_config = builder.set_n_neighbors()\
                        .set_weights()\
                        .set_algorithm()\
                        .set_leaf_size()\
                        .set_KNN_model()\
