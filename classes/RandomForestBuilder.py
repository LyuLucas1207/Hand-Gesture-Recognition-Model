...
class RandomForestBuilder:
    ...
    def set_n_estimators(self):
        ...
        while True:
            n_estimators = input("Enter the number of trees (positive integer or 'None'): ").strip()
    ...
    def set_max_depth(self):
        ...
        while True:
            max_depth = input("Enter the maximum depth of the trees (positive integer or 'None'): ").strip()
    ...
    def set_criterion(self):
        ...
        pt.print_boxed_options(options=RF_criterion, additional_option="None/N. Default")
    ...
    def set_RF_model(self):
        ...
        self.__RF_config['model'] = RandomForestClassifier(n_estimators=self.__RF_config['n_estimators'],
...
def create_RF_trainer():
    ...
    while loop:
        ...
        RF_config = RFB.set_n_estimators()\
                        .set_max_depth()\
                        .set_criterion()\
                        .set_random_state()\
                        .set_RF_model()\
