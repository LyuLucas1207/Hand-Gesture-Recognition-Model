...
class SklearnNeuralNetworkBuilder:
    ...
    def set_hidden_layer_sizes(self):
        ...
        while True:
            user_input = input("Enter hidden layer sizes as a comma-separated list (e.g., 128,64), or 'none' for default: ").strip()
            ...
            try:
                ...
                print("Invalid input. Please enter a valid comma-separated list of integers or 'none'.")
        return self
    ...
    def set_activation(self):
        ...
        while True:
            user_input = input("Select activation function (1-4, or 'none' for default): ").strip()
            if user_input.lower() in ['none', 'n']:
    ...
    def set_alpha(self):
        ...
        while True:
            user_input = input("Enter regularization strength (positive float, or 'none' for default): ").strip()
            if user_input.lower() in ['none', 'n']:
    ...
    def set_learning_rate(self):
        ...
        while True:
            user_input = input("Select learning rate schedule (1-3, or 'none' for default): ").strip()
            if user_input.lower() in ['none', 'n']:
    ...
    def set_random_state(self):
        ...
        while True:
            user_input = input("Enter random seed (positive integer, or 'none' for default): ").strip()
            if user_input.lower() in ['none', 'n']:
    ...
    def set_sklearn_NN_model(self):
        ...
        self.__NN_config['model'] = MLPClassifier(hidden_layer_sizes=self.__NN_config['hidden_layer_sizes'],
...
def create_NN_trainer():
    ...
    while loop:
        ...
        NN_config = builder.set_hidden_layer_sizes()\
                        .set_activation()\
                        .set_solver()\
                        .set_alpha()\
                        .set_learning_rate()\
