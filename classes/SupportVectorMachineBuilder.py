...
class SupportVectorMachineBuilder:
    ...
    def set_C(self):
        ...
        while True:
            user_input = input("Enter the regularization parameter C (positive float, or 'none' for default): ").strip()
            if user_input.lower() in ['none', 'n']:
    ...
    def set_degree(self):
        ...
        while True:
            user_input = input("Enter the degree (positive integer, or 'none' for default, only applies to poly kernel): ").strip()
            if user_input.lower() in ['none', 'n']:
    ...
    def set_random_state(self):
        ...
        while True:
            user_input = input("Enter the random seed (positive integer, or 'none' for default): ").strip()
            if user_input.lower() in ['none', 'n']:
    ...
    def set_SVM_model(self):
        ...
        self.__SVM_config['model'] = SVC(kernel=self.__SVM_config['kernel'],
